...
sn = int(sys.argv[1]) if len(sys.argv)>1 else 80 #default 0-7517
name = '%06d'%sn # 6 digit zeropadding
img = f'./training/image_02/0000/{name}.png'
binary = f'./training/velodyne/0000/{name}.bin'
with open(f'./training/calib/0000.txt','r') as f:
    calib = f.readlines()
